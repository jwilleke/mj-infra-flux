...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var client, existingApps, prometheusApp, provider, app, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    existingApps = _b.sent();
                    prometheusApp = existingApps.find(function (app) { return app.slug === 'prometheus'; });
                    if (prometheusApp) {
                        console.log('   ✅ Prometheus application already exists!');
                        console.log("   \u2022 Name: ".concat(prometheusApp.name));
                        console.log("   \u2022 Slug: ".concat(prometheusApp.slug));
                        console.log('='.repeat(70) + '\n');
                        return [2 /*return*/];
                    }
